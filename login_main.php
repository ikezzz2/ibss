      ...
      <center>
        ...
        <form id="loginForm" name="loginForm" action="" method="POST">
          <legend style="padding-right: 160px;">ログインフォーム</legend>
                ...
                <label for="userid">ユーザーID</label><input type="text" class="form" id="userid" name="userid" placeholder="ユーザーIDを入力" value="<?php if (!empty($_POST["userid"])) {echo htmlspecialchars($_POST["userid"], ENT_QUOTES);} ?>">
              </p>
                <p style="padding-right: 160px;">
                <label for="password">パスワード</label><input type="password" class="form" id="password" name="password" value="" placeholder="パスワードを入力">
              </p>
                <p style="padding-right: 160px;">
